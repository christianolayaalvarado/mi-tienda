...
useEffect(() => {
  ...
  return (
    <nav className="w-full bg-white shadow-md sticky top-0 z-50">
      ...
      {showLeft && (
  <div className="md:hidden absolute left-2 bottom-[1px] text-green-800 text-base opacity-80 animate-pulse pointer-events-none">
    ←
  </div>
)}

{showRight && (
  <div className="md:hidden absolute right-2 bottom-[1px] text-green-800 text-base opacity-80 animate-pulse pointer-events-none">
    →
  </div>
)}
