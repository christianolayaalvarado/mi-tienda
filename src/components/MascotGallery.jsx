                ...
                <h3 className="font-semibold text-gray-900 text-sm flex items-center justify-center gap-1 group/name">
                  ...
                  {isUnlocked && (
                    <span
                      ...
                      onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") startEditing(mascot.id, displayName, e); }}
                      className="opacity-0 group-hover/name:opacity-100 transition-opacity text-gray-400 hover:text-green-600 flex-shrink-0 cursor-pointer"
                      title="Editar nombre"
                    >
