...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/dashboard/admin/modals",
        label: "Modales",
        icon: "🪟",
        description: "Control de modales de bienvenida y temporadas",
        longDescription: "Habilita o deshabilita modales de bienvenida, ofertas y celebraciones temporales. Configura audiencia (registrados/no registrados) y programación de fechas.",
        photoGradient: "linear-gradient(135deg, #f97316 0%, #ea580c 100%)",
      ...
      },
      {
        ...
        longDescription: "Gestiona campañas de email marketing, envía newsletters, configura automatizaciones y mide el rendimiento de tus campañas.",
        photoGradient: "linear-gradient(135deg, #ec4899 0%, #db2777 100%)",
